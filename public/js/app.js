...
contactForm = {
  ...
  eL: function eventListeners() {
    ...
    $(contactForm.submitButton).on('click', function (e) {
      e.preventDefault(); // REMOVE ALL ERROR CLASSES
  ...
  validateForm: function validateForm() {
    contactForm.errors = 0; // Validate state dropdown list

    contactForm.checkDropdown(); // Validate first name, last name, address, city, specialty, license
    ...
    contactForm.checkForBlanks(contactForm.formCity); // Validate email

    contactForm.validateEmail(contactForm.formEmail); // Validate phone number

    contactForm.validatePhone(contactForm.formPhone); // Validate zip code

    contactForm.validateZip(contactForm.formZip); // If there are errors, call function to find and set the scrollTop so the page animates to the first error.
  ...
  validatePhone: function validatePhone(phone) {
    var phoneRegEx = /^[\(]?([2-9]{1})([0-9]{2})[\)\-\.\ ]?[\ ]?([0-9]{3})[\-\.\ ]?([0-9]{4})$/,
        phoneVal = $(phone).val(); // console.log('phoneVal  ', phoneVal);
  ...
  validateEmail: function validateEmail(email) {
    var emailRegEx = /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[ 0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/,
        emailVal = $(email).val(); // console.log('phoneVal  ', phoneVal);
  ...
  onlyAllowNumbers: function onlyAllowNumbers(evt) {
  ...
  showFormSuccessCopy: function showFormSuccessCopy() {
...
__webpack_require__(/*! /Users/kellymersereau/Projects/Sidework/HSHWNJ/jerseyhomewatch/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/kellymersereau/Projects/Sidework/HSHWNJ/jerseyhomewatch/resources/sass/app.scss */"./resources/sass/app.scss");
